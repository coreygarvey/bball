setwd('/Users/cgarvey/Documents/NBA/test/boxScores/')
library(plyr)
library(ggplot2)
library(scatterplot3d)

basicdata_raw = read.csv("basic.csv")
advdata_raw = read.csv("advanced.csv")
...
# Player Info
player_info = read.csv("playerInfo.csv")

# Player salaries by season
player_salaries_by_season = read.csv("playerSalaries.csv")
...
team_stats_by_season = read.csv("teams.csv")
...
write.csv(team_analysis, file = "team_analysis.csv")
