...
write.csv(player_per_game, file = "data/stats/player_per_game.csv")
write.csv(player_per_game_by_season, file = "data/stats/player_per_game_by_season.csv")
write.csv(player_per_game_by_season_team, file = "data/stats/player_per_game_by_season_team.csv")
write.csv(team_per_game, file = "data/stats/team_per_game.csv")
write.csv(team_per_game_by_season, file = "data/stats/team_per_game_by_season.csv")
write.csv(home_v_away_per_game, file = "data/stats/home_v_away_per_game.csv")
write.csv(home_v_away_per_game_by_season, file = "data/stats/home_v_away_per_game_by_season.csv")
write.csv(player_salaries, file = "data/stats/player_salaries.csv")
write.csv(team_salaries_by_season, file = "data/stats/team_salaries_by_season.csv")
write.csv(team_salaries, file = "data/stats/team_salaries.csv")
write.csv(salaries, file = "data/stats/player_salaries_by_season.csv")
write.csv(team_stats_by_season, file = "data/stats/team_stats_by_season.csv")
write.csv(team_analysis, file = "data/stats/team_analysis.csv")